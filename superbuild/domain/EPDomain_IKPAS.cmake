...
set(_domain_proj_dll_name "${proj}plugin.dll")
if(ANDROID)
    set(_domain_proj_dll_name "libqml_${proj}_${proj}plugin_${ANDROID_ABI}.so")
endif()

qsdf_delay_add_compile_definitions_to_plugin_core(
    PRIVATE
        QSDF_CURRENT_DOMAIN_PROJ="${proj}"
        QSDF_CURRENT_DOMAIN_PROJ_DLL_NAME="${_domain_proj_dll_name}"
