...
function Find-NDKPath {
    ...
    # location
    return $(Find-SDKPath | Join-Path -ChildPath "ndk/25.1.8937393")
}
...
$success = $architectures.AddStringAt(-1, $androidABI, "i686-linux-android")
...
& $adb -s emulator-5554 pull /system/bin/app_process $buildPath/app_process
& $adb -s emulator-5554 pull /system/bin/app_process32 $buildPath/app_process
& $adb -s emulator-5554 pull /system/bin/linker $buildPath/linker
& $adb -s emulator-5554 pull /system/lib/libc.so $buildPath/libc.so
