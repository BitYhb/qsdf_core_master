...
if (WIN32)
    ...
    set(_QSDF_HEADER_INSTALL_PATH "${CMAKE_INSTALL_INCLUDEDIR}/qsdf")
    set(_QSDF_CMAKE_INSTALL_PATH "${CMAKE_INSTALL_LIBDIR}/cmake")

    set(_QSDF_LIBRARY_BASE_PATH "${CMAKE_INSTALL_LIBDIR}")
    set(_QSDF_DATA_PATH "${CMAKE_INSTALL_DATAROOTDIR}/qsdf")
    set(_QSDF_LIBRARY_PATH "${_QSDF_LIBRARY_BASE_PATH}/qsdf")
    set(_QSDF_PLUGIN_PATH "${_QSDF_LIBRARY_BASE_PATH}/qsdf/plugins")
    set(_QSDF_BIN_PATH "${CMAKE_INSTALL_BINDIR}")
    set(_QSDF_LIBRARY_ARCHIVE_PATH ${_QSDF_BIN_PATH})
    set(_QSDF_LIBEXEC_PATH "${CMAKE_INSTALL_BINDIR}")
